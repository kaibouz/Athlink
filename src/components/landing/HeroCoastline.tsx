      ...
      >
        <defs>
          <linearGradient id="coast-line-grad" x1="0%" y1="0%" x2="0%" y2="100%">
            ...
            <stop offset="35%" stopColor="#334155" stopOpacity="0.42" />
            <stop offset="70%" stopColor="#1e3a5f" stopOpacity="0.38" />
        ...
        {CITIES.map((city, i) => (
          ...
          >
            <circle
              ...
              strokeWidth="1"
            />
            <circle cx={city.x} cy={city.y} r="1.15" fill="#1e3a5f" fillOpacity="0.7" />
            <text
              x={city.x + 12}
              y={city.y + 3.5}
