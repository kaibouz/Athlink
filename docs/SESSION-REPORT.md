# I think the main thing for the website is making sure that when you first open the website, it takes you to the two different options of. I think the main thing for the website. AthlinkPro セッション報告書
...
| 参加導線      | `/`（ロールゲートウェイ）、`/join` → `/` リダイレクト | コーチ/アスリート選択 → 各マーケティング HP |
| オンボーディング  | `/onboarding`                                                       | ロール別ウィザード                          |
| コーチ LP     | `/for-coaches`                                                      | コーチ向けマーケティングホーム                   |
...
| URL                                                                            | 確認内容                                 |
| ------------------------------------------------------------------------------ | ------------------------------------ |
| [http://localhost:3000](http://localhost:3000)                                 | ロールゲートウェイ（I'm a coach / I'm an athlete） |
| [http://localhost:3000/join](http://localhost:3000/join)                       | `/` へリダイレクト                            |
| [http://localhost:3000/for-coaches](http://localhost:3000/for-coaches)         | コーチ向け HP（ピッチング動画セクション付き）              |
| [http://localhost:3000/for-athletes](http://localhost:3000/for-athletes)       | アスリート向け LP（ピッチング動画セクション付き）            |
| [http://localhost:3000/admin](http://localhost:3000/admin)                     | エグゼクティブ管理（従来セッション認証）                 |
| [http://localhost:3000/coach/dashboard](http://localhost:3000/coach/dashboard) | コーチダッシュボード（従来認証）                     |
...
| URL                                                                  | 状態                                            |
| -------------------------------------------------------------------- | --------------------------------------------- |
| [https://athlink-taupe.vercel.app](https://athlink-taupe.vercel.app) | Vercel デフォルト URL（**main デプロイ = 本セッション変更未反映**） |
| [https://athlink.com](https://athlink.com)                           | DNS 設定待ち（`docs/DOMAIN.md` 参照）                 |
